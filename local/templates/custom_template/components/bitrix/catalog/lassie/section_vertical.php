...
//echo '<b>section_vertical.php</b>' . '<br>';
...
if ($isFilter || $isSidebar): ?>
		...
		<? if ($isFilter): ?>
				...
				////echo 'section_vertical: catalog.smart.filter' . '<br>';
				$APPLICATION->IncludeComponent(
					"bitrix:catalog.smart.filter",
					"lassie_visual_vertical",
					array(
...
<?endif?>
			...
			if (ModuleManager::isModuleInstalled("sale"))
			{
				...
				if (!empty($arRecomData) && $arParams['USE_GIFTS_SECTION'] === 'Y')
				{
					...
					<div data-entity="parent-container">
						...
						//echo 'section_vertical: sale.products.gift.section' . '<br>';
						// $APPLICATION->IncludeComponent(
			...
			{
				//echo 'section_vertical: catalog.compare.list' . '<br>';
				$APPLICATION->IncludeComponent(
			...
			//echo 'section_vertical: intSectionID' . '<br>';
