...
?>
		...
		{
			//echo 'element: catalog.compare.list' . '<br>';
		...
		echo 'element.php: catalog.element' . '<br>';
		...
		if ($elementId > 0)
		{
			...
			{
				//echo 'element: catalog.store.amount' . '<br>';
				$APPLICATION->IncludeComponent(
			...
			if (!empty($recommendedData))
			{
				...
				{
					?>
				<article class="product-page__section"data-entity="parent-container">
				<h2 class="heading product-page__title" 
					data-entity="header" data-showed="false" 
					style="display: none; opacity: 0;"
				><span class="heading__text"><?=GetMessage('CATALOG_POPULAR_IN_SECTION')?></span></h2>
							
							<?
							//echo 'element: catalog.section popular' . '<br>';
							$APPLICATION->IncludeComponent(
								'bitrix:catalog.section',
								'lassie',
								array(
									'IS_POPULAR_SECTION' => true,
									'IBLOCK_TYPE' => $arParams['IBLOCK_TYPE'],
									'IBLOCK_ID' => $arParams['IBLOCK_ID'],
									'SECTION_ID' => $arResult['VARIABLES']['SECTION_ID'],
									'SECTION_CODE' => $arResult['VARIABLES']['SECTION_CODE'],
				...
				<h2 class="heading product-page__title" 
					data-entity="header" data-showed="false" 
					style="display: none; opacity: 0;"
				><span class="heading__text"><?=GetMessage('CATALOG_RECOMMENDED_BY_LINK')?></span></h2>
							
							<?
							//echo 'element: catalog.recommended.products' . '<br>';
							$APPLICATION->IncludeComponent(
