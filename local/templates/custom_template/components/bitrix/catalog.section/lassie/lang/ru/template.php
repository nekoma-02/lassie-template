...
$MESS["CT_BCS_CATALOG_BTN_MESSAGE_CLOSE_POPUP"] = "Вернуться в каталог";
$MESS["CT_BCS_CATALOG_BTN_MESSAGE_BASKET_REDIRECT"] = "Оформить заказ";
...
$MESS["MESS_BTN_LAZY_LOAD_COUNT"] = "Загрузить еще #NUMBER# #ELEMENT#";
$MESS["MESS_COUNT"] = "товара";
$MESS["MESS_COUNT_MORE"] = "товаров";
$MESS["MESS_BTN_LAZY_ALL"] = "Показать все";
$MESS["MESS_SORT_BY"] = "Сортировать по:";
$MESS["MESS_DISPLAY_COUNT_BY"] = 'Отображать по:';
$MESS["MESS_SHOW_COUNTER"] = "Популярности";
$MESS["MESS_CATALOG_PRICE_1"] = "Цене";
$MESS["MESS_DATE_CREATE"] = "Новизне";
$MESS["MESS_CATALOG_AVAILABLE"] = "Наличию";
?>