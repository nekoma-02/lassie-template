	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order">
			...
			<div class="col-sm-9 bx-soa">
				...
				<div id="bx-soa-total-mobile" class="hide-block"></div>


				<!--	BUYER PROPS BLOCK	-->
				<fieldset id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active form__fieldset">
	
						<legend class="bx-soa-section-title form__title">
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					<!--	BASKET ITEMS BLOCK	-->
					<fieldset id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active form__fieldset">
				...
				<!--	REGION BLOCK	-->
				<fieldset id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active form__fieldset">
				...
				<? else:
					...
					?>
					<!--	DELIVERY BLOCK	-->
					<fieldset id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active form__fieldset" <?=($hideDelivery ? 'style="display:none"' : '')?>>
					...
					<!--	PAY SYSTEMS BLOCK	-->
					<fieldset id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active form__fieldset">
							<legend class="bx-soa-section-title form__title">
								<span class="bx-soa-section-title-count"></span><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?>
							</legend>
						<div class="bx-soa-section-content container-fluid"></div>
			...
			<!--	SIDEBAR BLOCK	-->
			<div id="bx-soa-total" class="col-sm-3 bx-soa-sidebar form__total">
				<div class="bx-soa-cart-total-ghost"></div>
				<div class="bx-soa-cart-total form__col-right">
