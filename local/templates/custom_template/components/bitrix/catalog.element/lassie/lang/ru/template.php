...
$MESS["CT_BCE_CATALOG_BTN_MESSAGE_CLOSE_POPUP"] = "Вернуться в каталог";
$MESS["CT_BCE_CATALOG_BTN_MESSAGE_BASKET_REDIRECT"] = "Оформить заказ";
...
$MESS['MESS_BTN_SUBSCRIBE'] = "Сообщить о поступлении размера";
$MESS['MESS_AVAILABLE'] = "Есть в наличии";
?>