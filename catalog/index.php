...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_ADD_TO_BASKET_ACTION_PRIMARY" => array(0=>"BUY",1=>"ADD",),
		...
		"DETAIL_MAIN_BLOCK_PROPERTY_CODE" => array(0=>"ARTNUMBER",1=>"MATERIAL",),
		...
		"FILTER_OFFERS_PROPERTY_CODE" => array(0=>"SIZES",1=>"",),
		"FILTER_PRICE_CODE" => array(0=>"BASE",),
		"FILTER_PROPERTY_CODE" => array(0=>"NEW_SALE_HIT",1=>"COLLECTION",2=>"MATERIAL",3=>"SEX",4=>"SEASON",5=>"COLOR",6=>"",),
		...
		"INSTANT_RELOAD" => "N",
		"LABEL_PROP" => array(0=>"NEWPRODUCT",1=>"SALELEADER",2=>"SPECIALOFFER",3=>"TREND",),
		...
		"LIST_PRODUCT_BLOCKS_ORDER" => "props,price,sku,quantity,quantityLimit,buttons",
